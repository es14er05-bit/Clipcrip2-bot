...
def get_rohat_clips(
    ...
    print("")
    print(
        "Rohat Twitch-Abfrage:"
    )
    print(
        f"Zeitraum: letzte "
        f"{ROHAT_SEARCH_DAYS} Tage"
    )
    print(
...
def main():
    ...
    def rohat_get_all_clips(
        token,
        broadcaster_id,
    ):
        return get_rohat_clips(
            core,
            token,
            broadcaster_id,
        )
