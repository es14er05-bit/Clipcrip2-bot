...
def process_video(video, number):
    ...
    try:
        ...
        print(
            "Dieser Clip wird nicht verarbeitet."
        )
        print("================================")
        print("")
    ...
    try:
        ...
        print("")
        print("================================")
        print("VIDEO-BEARBEITUNG FEHLGESCHLAGEN")
        print("================================")
        print(
            f"Video: {video}"
        )
...
def main():
    ...
    for number, video in enumerate(
        ...
        print(
            f"CLIP {number}/{min(5, len(videos))}"
        )
        print(
            "================================"
        )
    ...
    if successful == 0:
        raise RuntimeError(
            "Keiner der Clips konnte verarbeitet werden."
        )
